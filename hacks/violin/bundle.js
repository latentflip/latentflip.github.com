;(function(p,c,e){function r(n){if(!c[n]){if(!p[n])return;c[n]={exports:{}};p[n][0](function(x){return r(p[n][1][x])},c[n],c[n].exports);}return c[n].exports}for(var i=0;i<e.length;i++)r(e[i]);return r})({0:[function(require,module,exports){var App = require('./app');
...
},{"./app":1}],1:[function(require,module,exports){// Generated by CoffeeScript 1.3.3
(function() {
  var App, Backbone, Instrumentor, underscore,
  ...
  App.Views.ListView = (function(_super) {
    ...
    ListView.prototype.addModel = function(e) {
      if (e) {
        e.preventDefault();
        e.stopPropagation();
      }
...
},{"underscore":2,"backbone":3,"./instrumentor":4}],2:[function(require,module,exports){(function(){//     Underscore.js 1.4.4
...
},{}],3:[function(require,module,exports){(function(){//     Backbone.js 0.9.10
...
},{"underscore":5}],5:[function(require,module,exports){(function(){//     Underscore.js 1.4.4
//     http://underscorejs.org
//     (c) 2009-2013 Jeremy Ashkenas, DocumentCloud Inc.
//     Underscore may be freely distributed under the MIT license.
...
},{}],4:[function(require,module,exports){// Generated by CoffeeScript 1.3.3
(function() {
  var EventEmitter, Graph, Instrumentor, _,
    __slice = [].slice,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"underscore":2,"./graph":6}],6:[function(require,module,exports){// Generated by CoffeeScript 1.3.3
(function() {
  var Graph,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
