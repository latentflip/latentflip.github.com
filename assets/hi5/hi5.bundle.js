...
(function (factory) {
  ...
  window.Hi5 = function(options) {
    $(function() {
      ...
      if (assetPath[assetPath.length - 1] != '/') assetPath += '/';
      ...
      var id = options.id || normalizeUrl();

      $('body').append( $("<link href='"+assetPath+"hi5.bundle.css' type='text/css' rel='stylesheet'>") );
      $.getScript("//platform.twitter.com/widgets.js");
      $.getScript("//hi5-server.herokuapp.com/socket.io/socket.io.js", function() {
        ...
        $('#hi5-circle').tooltip({
          title: "Like this post? ^5 me to say thanks.",
          trigger: 'manual',
          placement: placement,
          container: 'body'
        });
        ...
        var mousemove = function(ev) {
          ...
          $cursor.css({
            left: ev.pageX - elP.left,
            top: ev.pageY - elP.top
          });
        };
        ...
        var click = function() {
          ...
          $cursor.animate(to, 50, function() {
            $('#hi5-outer').unbind('mouseenter', mouseenter);
            $('#hi5-outer').unbind('mouseleave', mouseleave);
        ...
        var showCursor = function() {
          $('#hi5-outer').css({cursor: 'none'});
          $cursor.show();
          $('#hi5-circle').tooltip('show');
        };

        var hideCursor = function() {
          $('#hi5-outer').css({cursor: 'auto'});
          $cursor.hide();
          $('#hi5-circle').tooltip('hide');
        }
        ...
        var mouseenter = function() {
          ...
          $('#hi5-outer').bind('mousemove', mousemove);
          $('#hi5-outer').bind('click', click);
          $('#hi5-outer').bind('mouseleave', mouseleave);
        }

        if (!$.cookie('hi5ed:'+id)) {
          $('#hi5-outer').bind('mouseenter', mouseenter);
        } else {
          done();
        }
      });
